...
export const HeaderSongs = styled.SafeAreaView`
width: 100%;
background-color: #0d0d0d;
flex-direction: row;
height: 70px;
...
export const SongsImage = styled.Image`
width: 150px;
height: 150px;
`;

export const SongsTitle = styled.Text`
font-size: 16px;
font-weight: 500;
color: #D0D1D3;
margin-top: 20px;
...
export const SongsDescription = styled.Text`
font-size: 14px;
font-weight: 400;
color: #B0B2B5;
font-family: 'SF Pro Text';
